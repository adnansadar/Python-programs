...
# followed by K pairs of numbers (one for each ball rolled), determine
# which pins remain standing after all the balls have been rolled.
# The balls are numbered from 1 to N (inclusive) for this situation. The subsequent number pairs,
# one for each K represent the start to stop (inclusive) positions of the pins that were knocked down with each role.
